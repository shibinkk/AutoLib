...
public final class BookreadBinding implements ViewBinding {
  @NonNull
  ...
  private BookreadBinding(@NonNull ConstraintLayout rootView,
      @NonNull AutoCompleteTextView autoCompleteText, @NonNull Button button2,
  ...
  @NonNull
  public static BookreadBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static BookreadBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.bookread, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static BookreadBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new BookreadBinding((ConstraintLayout) rootView, autoCompleteText, button2,
          imageButton2, imageButton9, textInputLayout6, textInputLayout7, textInputLayout8,
          toolbar);
    }
