...
public final class StudenthomeBinding implements ViewBinding {
  ...
  private StudenthomeBinding(@NonNull ConstraintLayout rootView, @NonNull ImageButton imageButton8,
      ...
      @NonNull LinearLayout linearLayout5, @NonNull TextView textView, @NonNull TextView textView2,
  ...
  public static StudenthomeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.studenthome, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static StudenthomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new StudenthomeBinding((ConstraintLayout) rootView, imageButton8, imageButton9,
          imageView, imageView2, imageView3, imageView4, imageView5, imageView6, imageView7,
          linearLayout3, linearLayout4, linearLayout5, textView, textView2, textView3, toolbar);
    }
