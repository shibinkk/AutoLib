...
public final class StudentdbBinding implements ViewBinding {
  @NonNull
  ...
  private StudentdbBinding(@NonNull ConstraintLayout rootView, @NonNull Button button2,
  ...
  @NonNull
  public static StudentdbBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static StudentdbBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.studentdb, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static StudentdbBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new StudentdbBinding((ConstraintLayout) rootView, button2, imageButton8,
          textInputLayout, textInputLayout2, textInputLayout4, textView8, toolbar);
    }
