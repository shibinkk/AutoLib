...
public final class BookdbBinding implements ViewBinding {
  @NonNull
  ...
  private BookdbBinding(@NonNull ConstraintLayout rootView, @NonNull Button button2,
  ...
  @NonNull
  public static BookdbBinding inflate(@NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static BookdbBinding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent,
      boolean attachToParent) {
    View root = inflater.inflate(R.layout.bookdb, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static BookdbBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new BookdbBinding((ConstraintLayout) rootView, button2, imageButton8, textInputLayout,
